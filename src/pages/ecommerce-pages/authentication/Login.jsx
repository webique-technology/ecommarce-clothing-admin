    ...
    <main className="flex h-screen w-full items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-[480px]">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 class="text-primary font-h1 tracking-tight">AdminPanel</h1>
          <p class="text-on-surface-variant font-body-sm mt-1">Ecommerce Management Console</p>
        </div>
        <div className="block-form space-y-5 w-full">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="flex items-center mt-5 gap-2">
              ...
              <label className="ml-sm text-on-surface-variant font-body-sm cursor-pointer select-none" for="remember">Remember me for 30 days</label>
            </div>
            ...
            <button class="w-full bg-surface-bright border border-outline-variant text-on-surface py-3 px-md rounded-xl font-label-md hover:bg-surface-container-low active:scale-[0.98] transition-all flex items-center justify-center gap-3" type="button">
